...
export class AppComponent implements OnInit{
  ...
  backgrounds: string[] = ['https://images.unsplash.com/photo-1632504102499-7dc472b50653?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=1440&ixid=MnwxfDB8MXxyYW5kb218MHx8fHx8fHx8MTYzMjkzMDQ4MQ&ixlib=rb-1.2.1&q=80&w=2560'
  ]
  ...
  async changeBGImage() {
    ...
    const result = await fetch('https://source.unsplash.com/random/1920x1080', {
      method: 'HEAD'        // to get image url, not download
    })
